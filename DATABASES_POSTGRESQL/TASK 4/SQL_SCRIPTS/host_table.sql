...
calculated_host_listings_count FROM "Listing2";
ALTER TABLE "Host"
...
ALTER TABLE "Host"
RENAME host_response_time TO respone_time;
ALTER TABLE "Host"
RENAME host_response_rate TO response_rate;
ALTER TABLE "Host"
...
ALTER TABLE "Listing2" ADD CONSTRAINT host_id_fkey FOREIGN KEY (host_id) REFERENCES "Host" (id); 
